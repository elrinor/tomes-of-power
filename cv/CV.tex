...
%\end{wrapfigure}
	...
	Implemented initial version of the HD Witness client application. Streamlined the UI making it very intuitive and used OpenGL to provide a fluid and visually appealing user experience. Various sources have described HD Witness as the most aesthetically pleasing and user-friendly VMS on the market, which has helped the company to gain a competitive edge.
	...
	Combild was started to create an IT service management (ITSM) system that would target small companies and IT outsourcers. At the time competing solutions on the market such as 1C:ITIL and Itilium were not suitable for use by IT outsourcers. Combild was to offer a lightweight and user-friendly ITSM system with a licensing model specifically targeted at small companies and IT oursourcers.
    ...
    Was additionally working on \url{http://mathege.ru}, a portal for national mathematics exam in Russia developed in Java using Apache Struts web framework. Did both frontend and backend development and have implemented a \LaTeX~to html converter that was used for importing problems into the system.
