...
%\end{wrapfigure}
    ...
    Was hired as an engineer and for the first year was working on the next generation index that would speed up the search process. Currently in the process of shipping it, expecting significant speedup.
