...
%\end{wrapfigure}
    ...
    LinkedIn: \url{https://www.linkedin.com/pub/alexander-fokin/41/9a4/452}
    ...
    \textbf{Network Optix, Inc.}, Moscow, Russian Federation, then Los Angeles, USA \vspace{2mm}\\\vspace{1mm}%
    ...
    \textbf{Intel Research Lab at the Moscow State University}, Moscow, Russian Federation \vspace{2mm}\\\vspace{1mm}%
